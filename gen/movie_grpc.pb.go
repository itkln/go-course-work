...
const (
	RatingService_GetAggregatedRaing_FullMethodName = "/RatingService/GetAggregatedRaing"
...
type RatingServiceClient interface {
	GetAggregatedRaing(ctx context.Context, in *GetAggregatedRatingRequest, opts ...grpc.CallOption) (*GetAggregatedRatingResponse, error)
...
func (c *ratingServiceClient) GetAggregatedRaing(ctx context.Context, in *GetAggregatedRatingRequest, opts ...grpc.CallOption) (*GetAggregatedRatingResponse, error) {
	out := new(GetAggregatedRatingResponse)
	err := c.cc.Invoke(ctx, RatingService_GetAggregatedRaing_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RatingServiceServer interface {
	GetAggregatedRaing(context.Context, *GetAggregatedRatingRequest) (*GetAggregatedRatingResponse, error)
...
func (UnimplementedRatingServiceServer) GetAggregatedRaing(context.Context, *GetAggregatedRatingRequest) (*GetAggregatedRatingResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAggregatedRaing not implemented")
}
...
func _RatingService_GetAggregatedRaing_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetAggregatedRatingRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RatingServiceServer).GetAggregatedRaing(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RatingService_GetAggregatedRaing_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RatingServiceServer).GetAggregatedRaing(ctx, req.(*GetAggregatedRatingRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var RatingService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetAggregatedRaing",
			Handler:    _RatingService_GetAggregatedRaing_Handler,
		},
		{
